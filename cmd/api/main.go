...
func main() {
	...
	server := httpapi.NewServer(config, accountRepo, sessionRepo, oauthCallback, createFamily, sleepCtxResolver, createSleepProfile, startSleep, stopSleep, getSleepHistory, getElapsedTime)
